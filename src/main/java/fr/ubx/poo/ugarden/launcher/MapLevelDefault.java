...
public class MapLevelDefault extends MapLevel {
    ...
    private final MapEntity[][] level1 = {
            ...
            {Grass, Player, Grass, Grass, Grass, Land, Land, Land, Apple, Tree, Grass, Grass, Tree, Tree, Apple, Carrots, Key, Grass},
            ...
            {Grass, Tree, Grass, Tree, Grass, Grass, Grass, Grass, Grass, Grass, Grass, Grass, Grass, Grass, Grass, DoorNextClosed, Grass, Grass}
    };
